...
@noCarrinhoAtualizarInformacoes @teste @TodosOs7Cenarios
Scenario: Colocar o produto no carrinho e verificar o valor
  When opto por escolher o produto "Printed Chiffon Dress" -> "More"
  And opto por aumentar a quantidade do produto cinco vezes resultando em três
  ...
  And Verifico se o total da compra é de "$51.20"
